...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { tag_programming_id: @tutorial.tag_programming_id, title: @tutorial.title } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { tag_programming_id: @tutorial.tag_programming_id, title: @tutorial.title } }
